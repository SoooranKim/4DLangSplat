dataset_path=../data/hypernerf/torchocolate
image_dir=${dataset_path}/rgb/2x
output_dir=preprocess_result/torchocolate
video_features_name=video_features
segmentation_dir=../submodules/4d-langsplat-tracking-anything-with-deva/output/torchocolate/large/origin_mask_large
cd preprocess
